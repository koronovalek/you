...
Камера по умолчанию — **дрон**. Он сталкивается со всем, что видно: статика растеризуется
в воксельную карту 0.35 м (крыши, заборы, лодки, беседка), плюс стволы, сердцевины крон,
ящики и бочки. Дрон скользит вдоль препятствий, невидимых стен нет. Ниже 0.4 м над землёй, водой или крышей опуститься нельзя.
...
- **Разрушаемость.** Взрыв ломает деревья: ствол трескается у земли, верх кренится от
  ...
  пень, а лежачий ствол становится укрытием. Из излома сыплются опилки и кора, ударная волна
  стряхивает листву и хвою с крон вокруг — листья кружатся, ложатся ковром и плавают по воде.
  Лавки и поленницы разлетаются по доскам и поленьям. Ящики разлетаются на доски, топливные бочки
...
- **Озеро.** Цвет воды — свет, прошедший сквозь толщу: у берега видно дно с каустикой, на
  глубине — тёмная торфяная вода с отражением леса (Френель, F0 = 0.02). По воде бегут пятна
  ряби от порывов, между ними вода почти зеркальная, у берега — ряска, на солнце — узкая
  дорожка бликов с ограниченной яркостью. Камыш и рогоз стоят куртинами прямо в
...
- **Растительность.** Трава — настоящие травинки на GPU, без пересборки на CPU при движении;
  по полю бегут волны порывов, против солнца трава и листва светятся. На полянах — ромашки,
  лютики, клевер, колокольчики и иван-чай куртинами, у части травинок — метёлки. На земле —
  шишки, сучья, камешки, грибы и опавшие листья под берёзами. Кусты (лещина, ива,
...
| [`src/world/litter.js`](src/world/litter.js), [`src/fx/leaves.js`](src/fx/leaves.js) | лесная подстилка; листья, хвоя и опилки с аэродинамикой |
| [`src/core/voxels.js`](src/core/voxels.js) | воксельная карта занятости для столкновений дрона |
